...
namespace SnWebApplication.Api.MySql.TokenAuth
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddSenseNetMySqlProviders(configureInstallation: installOptions =>
                {
                    Configuration.Bind("sensenet:install:mysql", installOptions);
                })
                .AddSenseNetOData()
                .AddSenseNetWebHooks()
                .AddSenseNetWopi()
