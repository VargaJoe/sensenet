...
{
    public class MySqlSchemaWriter : SchemaWriter
    {
        private readonly string _connectionString;

        public MySqlSchemaWriter(IOptions<ConnectionStringOptions> connectionStrings)
        {
        ...
        public override async STT.Task WriteSchemaAsync(RepositorySchemaData schema)
        {
            ...
            var installer = new MySqlSchemaInstaller(_connectionString);
